...
- **Accent is the brand ramp and is the unique case:** it shifts hue across the axis (`accent.60` blue in light -> `accent.50` cyan in dark). `semantic.accent.primary` uses the accent ramp. All other families are single-hue and just lighten.
